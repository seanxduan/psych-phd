...
#nope gotta set age, gender ,etc. damn
...
#nice mostly good HOWEVER we should probably reset and get our 'guesses' set up as well RIP
#or we can cut them out entirely? regardless, GJ

write.csv(pilot_long_clean,'pilot_cleanish.csv')
